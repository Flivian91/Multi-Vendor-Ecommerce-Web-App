...
function CustomDataTable() {
  const PAGE_SIZE = 10; //No of Item on a page
  const [currentPage, setCurrentPage] = useState(1); //Current Page eg page 1, 2,3
  const startIndex = (currentPage - 1) * PAGE_SIZE; //Start Index of the data
            ...
            <ul className="inline-flex -space-x-px rtl:space-x-reverse text-sm h-10">
              <li>
                <button
                  ...
                  className="flex items-center disabled:cursor-not-allowed disabled:bg-gray-300 justify-center px-3 h-10 ms-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                >
                  Previous
                </button>
              </li>
              ...
              <li>
                <button
                  ...
                  className="flex items-center justify-center px-3 h-10 leading-tight disabled:cursor-not-allowed disabled:bg-gray-300 text-gray-500 bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                >
                  Next
                </button>
              </li>
